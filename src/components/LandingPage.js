    ...
    >
      <Box sx={{ flex: '1 0 auto' }}>
        ...
        <Box sx={{ 
          ...
          position: 'relative',
          overflow: 'hidden',
          backgroundImage: 'linear-gradient(rgba(26, 35, 126, 0.92), rgba(26, 35, 126, 0.92)), url("https://images.unsplash.com/photo-1589391886645-d51941baf7fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80")',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        ...
        <Box sx={{ 
          ...
          position: 'relative',
          overflow: 'hidden',
          backgroundImage: 'linear-gradient(rgba(26, 35, 126, 0.95), rgba(26, 35, 126, 0.95)), url("https://images.unsplash.com/photo-1589391886645-d51941baf7fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80")',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundAttachment: 'fixed',
          color: 'white',
